; ModuleID = '<stdin>'
source_filename = "c/04-unknown.c"
...
define i32 @main(i32, i8**) #0 !dbg !6 {
  ...
  %5 = sext i32 %0 to i64, !dbg !24
  %6 = getelementptr inbounds [4 x i32], [4 x i32]* %3, i64 0, i64 %5, !dbg !24
...
!1 = !DIFile(filename: "c/04-unknown.c", directory: "/home/nick/teaching/886/overflower-template/test")
!2 = !{}
...
!24 = !DILocation(line: 5, column: 10, scope: !6)
!25 = !DILocation(line: 5, column: 3, scope: !6)
