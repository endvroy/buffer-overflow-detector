; ModuleID = '<stdin>'
source_filename = "c/06-mergeunsafe.c"
...
; <label>:7:                                      ; preds = %2
  call void @llvm.dbg.value(metadata i32 -1, i64 0, metadata !27, metadata !14), !dbg !28
  br label %8
...
!1 = !DIFile(filename: "c/06-mergeunsafe.c", directory: "/home/nick/teaching/886/overflower-template/test")
!2 = !{}
...
!27 = !DILocalVariable(name: "index", scope: !6, file: !1, line: 5, type: !9)
!28 = !DILocation(line: 5, column: 7, scope: !6)
